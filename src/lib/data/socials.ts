export interface Social {
	label: string;
	href: string;
	/** インライン SVG の path データ (24x24 viewBox) */
	icon: string;
}
...
export const socials: Social[] = [
	{
		label: 'GitHub',
		href: 'https://github.com/baseballyama',
	...
	{
		label: 'X',
		href: 'https://x.com/baseballyama_',
		icon: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.66l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.45-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77Z'
	}
];

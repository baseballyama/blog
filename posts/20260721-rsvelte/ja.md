...
交互実行 10 ペアの比率中央値は **19.4 倍**(範囲 18.0〜23.5)だった。型検査と違って Lint には TS エンジンのような共通依存がないため、エンドツーエンドでも 2 桁の差が出る。メモリも 0.86GB → 0.05GB と大きく減る。
